...
public final class PermissionUtils {
     ...
     */
    public static boolean isGranted(final List<String> permissions) {
     ...
     */
    public static PermissionUtils permission(final List<String> permissions) {
    ...
    private PermissionUtils(final List<String> permissions) {
